...
\newfontfamily{\ar}{Noto Kufi Arabic}
...
\newfontfamily{\ja}{Noto Sans CJK JP}
\newfontfamily{\ka}{Noto Sans Georgian}
\newfontfamily{\ko}{Noto Sans CJK KR}
...
\newfontfamily{\ur}{Noto Nastaliq Urdu}
\newfontfamily{\zhtw}{Noto Sans CJK TC}
