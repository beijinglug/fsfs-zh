...
出于隐私考虑，您必须避免使用私有软件，这是由于私有软件赋予他人控制您的计算机使用的权力，它们很可能在监控您[^surveilance-20]。您还应该拒绝使用“作为软件替代品的服务”（SaaSS）[^surveilance-21]，同样由于这赋予了他人控制您的计算机使用的权力，它要求您将全部相关数据提交到它们的服务器。
