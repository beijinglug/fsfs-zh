...
如同我们已经倡导了 30 多年的，使用自由软件是掌控我们自己的数字生活的第一步。这也包括了避免被监控。我们不可能信任任何专有软件；由于美国国家安全局（NSA）通过利用[^surveilance-2]甚至还有制造[^surveilance-3]专有软件中的安全漏洞来入侵我们自己的计算机和路由器。自由软件赋予了我们控制自己计算机的权利，但仅凭这一点并不足以在我们涉足互联网的时候保护我们的隐私[^surveilance-4]。
...
出于隐私考虑，您必须避免使用专有软件，这是由于专有软件赋予他人控制您的计算机使用的权力，它们很可能在监控您[^surveilance-20]。您还应该拒绝使用“服务作为软件替代品”（SaaSS）[^surveilance-21]，同样由于这赋予了他人控制您的计算机使用的权力，它要求您将全部相关数据提交到它们的服务器。
