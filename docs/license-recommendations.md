...
对于短的、次要的文档工作，例如参考卡片，最好使用 GNU all-permissive 许可证[^recon-6]，因为一份 GFDL 的复本难以放进一张参考卡片里面。不要用CC-BY，因为它和 GFDL 不兼容。

对于 man 手册页面，如果页面很长，我们推荐 GFDL，而如果它很短，则推荐 GNU all-permissive 许可证。
