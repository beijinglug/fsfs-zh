...
[^freesw-tivo]: “Tivo”是美国一大有线电视机顶盒产品，“Tivo 化”（Tivoization）是指该产品包含了以 GPL 许可证发布的软件，但实际上用户不能修改，因为一旦设备发现软件经过修改就会自动关机。相关内容可参考本书《为何升级到 GPLv3》一文。
...
[^freesw-2]: 可参见《为什么自由软件需要自由的文档》一文
