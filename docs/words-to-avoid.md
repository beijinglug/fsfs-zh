...
我们从不将自由软件描述为私有软件之外的替代品，由于这一单词假设所有“替代品”都是合法的，并且每增加一种“替代品”都对用户有利。事实上，这一单词假设自由软件应该和那些不尊重用户自由的软件共存。

我们坚信以自由软件形式发布是发布软件以供他人使用的唯一符合伦理的方式。而其他方式，不论是私有软件还是“服务作为软件替代品”（SaaSS）都会迫使用户屈从[^2]。因此我们认为不向用户提供这些自由软件之外的“替代品”才是好的。
...
与之相反，对其生存环境持有伦理立场，可以决定保护那些如果没有人为干预就会消亡的东西——诸如公民社会、民主、人权、和平、公共卫生、稳定的气候、洁净的空气和水、濒危物种、传统艺术……以及计算机用户的自由。
...
维基百科（Wikipedia）以一种使人混淆的方式使用“源代码模型”这一概念。从表面看，它指的是程序的源代码如何分发，但其文本将这一概念与开发方法论混淆起来。它将区分“开放源代码”和“共享源代码”作为答案，但它们是重叠的——微软将后者作为一种市场概念以覆盖一系列实践，其中的一些也是“开放源代码”的。因此，这一概念实际上未能传达任何合乎逻辑的信息，但它却连篇累牍地为把自由软件描述为“开源”提供了机会。
