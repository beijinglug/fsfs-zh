...
b)在通用公共授权下，对于副本来说本许可证无可接受的附加许可。
...
您可以将基于该库的作品的库设施并排放在一个单独的库中，与其他非应用程序且不在本许可范围内的图书馆设施并排放置，并根据您的选择，将这样组合的库放在下列两种情况下:

a)与库组合的库，和库的同一份作品的副本一起，和其他库的设施没有任何联系，这是要根据这个许可证的条款进行的。

b)对组合库进行醒目的通知，说明其部分是基于库的作品，并解释在哪里找到与之相关的未联合的作品形式。
