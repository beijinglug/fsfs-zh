...
**在互联网环境中，专有软件并非剥夺您的自由的唯一方式。“服务作为软件替代品”（Service as a Software Substitute），或者 SaaSS，是另一种赋予其他人支配您的计算的权力的途径。**
...
只要有了自由软件，我们作为用户就能夺回我们计算的控制权。专有软件仍然存在，但我们可以将其排除在生活之外，并且我们中的很多人已经在这么做。然而现在，我们对自己的计算的控制权面临新的威胁：服务作为软件的替代品（SaaSS）。为了捍卫我们的自由，我们必须像拒绝专有软件那样拒绝 SaaSS。
