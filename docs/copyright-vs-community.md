...
由于存在后门，我们是在大约 3 个月前知道的它的存在，由于亚马逊使用了它。亚马逊向所有 Kindle 发送了一条指令以删除一本特定的书，即乔治·奥威尔（George Orwell）的《一九八四》。是的，它们找不出一本更具讽刺意味的书来删除了。这就是我们如何知道亚马逊拥有某种后门并且通过它远程删除电子书的。
